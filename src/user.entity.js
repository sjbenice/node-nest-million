...
let User = (() => {
    ...
    let _problem_decorators;
    let _problem_initializers = [];
    let _problem_extraInitializers = [];
    var User = _classThis = class {
        constructor() {
            ...
            this.age = (__runInitializers(this, _last_name_extraInitializers), __runInitializers(this, _age_initializers, void 0));
            this.gender = (__runInitializers(this, _age_extraInitializers), __runInitializers(this, _gender_initializers, void 0));
            this.problem = (__runInitializers(this, _gender_extraInitializers), __runInitializers(this, _problem_initializers, void 0));
            __runInitializers(this, _problem_extraInitializers);
        }
    };
    ...
    (() => {
        ...
        _problem_decorators = [(0, typeorm_1.Column)()];
        ...
        __esDecorate(null, null, _problem_decorators, { kind: "field", name: "problem", static: false, private: false, access: { has: obj => "problem" in obj, get: obj => obj.problem, set: (obj, value) => { obj.problem = value; } }, metadata: _metadata }, _problem_initializers, _problem_extraInitializers);
